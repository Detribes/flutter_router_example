...
import 'package:flutter_router_example/src/core/common/observer.dart';
import 'package:flutter_router_example/src/core/router/scope/root_router_scope.dart';
import 'package:flutter_router_example/src/di/common/initialization_helper.dart';
import 'package:flutter_router_example/src/di/common/initialization_result.dart';
    ...
    DependencyScope(
      ...
      child: RootRouterScope(
        ...
        child: SettingsScope(
          ...
          child: Boostrap(scaffoldMessengerKey: scaffoldMessengerKey),
        ),
      ),
    ),
  );
...
class Boostrap extends StatelessWidget {
  const Boostrap({super.key, required this.scaffoldMessengerKey});
